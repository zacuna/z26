 ...
 * Values match globals.css primitives. Tailwind palette is oklch (v4 default).
 */

/** OKLCH color string (full oklch() as in globals.css / getComputedStyle) */
export type OklchValue = string;

/** Tailwind v4 color palette in oklch (tailwindcss.com/docs/colors) */
export const TAILWIND_COLOR_PALETTE: Record<
  string,
  Record<string, OklchValue>
> = {
  red: {
...
/** Flattened list of all Tailwind colors for dropdown: { label, value (oklch), family } */
...
/** Color families in display order (Tailwind v4 + tweakcn-style) */
